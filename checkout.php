                        ...
                        <div class="checkout__order">
                            ...
                            <ul class="checkout__total__products">
                                <?php foreach ($_SESSION['cart'] as $key => $value) { ?>
                                    <li><?php echo $value['product_quantity']; ?> <?php echo $value['product_name']; ?> <span> <?php echo setPrice(($value['product_price'] * $convert_dollar)); ?></span></li>
                                <?php } ?>
                            </ul>
                            <ul class="checkout__total__all">
                                <li>Total <span><?php echo setPrice(($_SESSION['total'] * $convert_dollar)); ?></span></li>
                            </ul>
