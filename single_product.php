                    ...
                    <div class="row d-flex justify-content-center">
                        <div class="col-lg-8">
                            <div class="product__details__text">
                                ...
                                <h3><?php echo setPrice($row['product_price'] * $convert_dollar); ?></h3>
                                ...
                                <div class="product__details__last__option">
                                    ...
                                    <ul>
                                        <li><span>Discount:</span> <?php echo $row['product_special_offer']." %"; ?></li>
                    ...
                    <div class="row">
                        <div class="col-lg-12">
                            <div class="product__details__tab">
                                <ul class="nav nav-tabs" role="tablist">
                                    <li class="nav-item">
                                        <a class="nav-link active" data-toggle="tab" href="#tabs-5" role="tab">Description - Mô tả</a>
                                    </li>
                                </ul>
                                <div class="tab-content">
