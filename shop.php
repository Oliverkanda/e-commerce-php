                    ...
                    <div class="shop__sidebar__accordion">
                        <form method="POST" action="shop.php">
                            <div class="accordion" id="accordionExample">
                                                ...
                                                <ul>
                                                    <li>
                                                        <div class="form-check">
                                                            <input class="form-check-input" type="radio" value="vip" name="category" id="category_one" <?php if (isset($category) && $category == 'vip') {
                                                                                                                                                                echo 'checked';
                                                                                                                                                            } ?>>
                                                    ...
                                                    <li>
                                                        <div class="form-check">
                                                            <input class="form-check-input" type="radio" value="anime" name="category" id="category_two" <?php if (isset($category) && $category == 'anime') {
                                                                                                                                                                echo 'checked';
                                                                                                                                                            } ?>>
                                                            <label class="form-check-label" for="category">
                                                                anime
                                                    ...
                                                    <li>
                                                        <div class="form-check">
                                                            <input class="form-check-input" type="radio" value="normal" name="category" id="category_three" <?php if (isset($category) && $category == 'normal') {
                                                                                                                                                                echo 'checked';
                                                                                                                                                            } ?>>
                                                            <label class="form-check-label" for="category">
                                                                normal
                                ...
                                <div class="card">
                                    <div class="card-heading">
                                        <a data-toggle="collapse" data-target="#collapseTwo">Brand <i class="fas fa-chevron-down"></i></a>
                                    </div>
                                        ...
                                        <div class="card-body">
                                            <div class="shop__sidebar__brand">
                                                <ul>
                                                    <li>
                                                        <div class="form-check">
                                                            <input class="form-check-input" type="radio" value="Rolex" name="brand" id="brand_one" <?php if (isset($brand) && $brand == 'Rolex') {
                                                                                                                                                        echo 'checked';
                                                                                                                                                    } ?>>
                                                    ...
                                                    <li>
                                                        <div class="form-check">
                                                            <input class="form-check-input" type="radio" value="Hermes" name="brand" id="brand_two" <?php if (isset($brand) && $brand == 'Hermes') {
                                                                                                                                                                echo 'checked';
                                                                                                                                                            } ?>>
                                                            <label class="form-check-label" for="brand">
                                                                Hermes
                                                    ...
                                                    <li>
                                                        <div class="form-check">
                                                            <input class="form-check-input" type="radio" value="Channel" name="brand" id="brand_three" <?php if (isset($brand) && $brand == 'Channel') {
                                                                                                                                                            echo 'checked';
                                                                                                                                                        } ?>>
                                                            <label class="form-check-label" for="brand">
                                                                Channel
                                                    ...
                                                    <li>
                                                        <div class="form-check">
                                                            <input class="form-check-input" type="radio" value="Gucci" name="brand" id="brand_four" <?php if (isset($brand) && $brand == 'Gucci') {
                                                                                                                                                            echo 'checked';
                                                                                                                                                        } ?>>
                                                            <label class="form-check-label" for="brand">
                                                                Gucci
                                                    ...
                                                    <li>
                                                        <div class="form-check">
                                                            <input class="form-check-input" type="radio" value="Louis Vuitton" name="brand" id="brand_five" <?php if (isset($brand) && $brand == 'Louis Vuitton') {
                                                                                                                                                        echo 'checked';
                                                                                                                                                    } ?>>
                                                            <label class="form-check-label" for="brand">
                                                                Louis Vuitton
                                                    ...
                                                    <li>
                                                        <div class="form-check">
                                                            <input class="form-check-input" type="radio" value="Dior" name="brand" id="brand_five" <?php if (isset($brand) && $brand == 'Dior') {
                                                                                                                                                        echo 'checked';
                                                                                                                                                    } ?>>
                                                            <label class="form-check-label" for="brand">
                                                                Dior
                                                    ...
                                                    <li>
                                                        <div class="form-check">
                                                            <input class="form-check-input" type="radio" value="Valentinor" name="brand" id="brand_five" <?php if (isset($brand) && $brand == 'Valentino') {
                                                                                                                                                        echo 'checked';
                                                                                                                                                    } ?>>
                                                            <label class="form-check-label" for="brand">
                                                                Valentino
