...
<ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
    ...
    <a class="sidebar-brand d-flex align-items-center justify-content-center" href="index.php">
        ...
        <div class="sidebar-brand-text mx-3"> Keychain </div>
    </a>
    ...
    <li class="nav-item">
        ...
        <div id="collapseTwo" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
            <div class="bg-white py-2 collapse-inner rounded">
                ...
                <a class="collapse-item" href="create_product.php">Thêm sản phẩm</a>
            </div>
        </div>
    </li>
    ...
    <div class="modal-dialog modal-dialog-centered" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="exampleModalLongTitle">Info Admin - Thông tin</h5>
            ...
            <div class="modal-body">
                <div class="row">
                    <div class="col-sm-6 col-md-6 text-center">
                        <img src="<?php echo '../assets/img/about/' . $_SESSION['admin_photo2']; ?>" alt="pic" class="rounded img-responsive" width="150" height="200" />
                    </div>
