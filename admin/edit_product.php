                                ...
                                <div class="col-sm-6">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <select class="form-control" name="product_brand">
                                            ...
                                            <option value="No brand" <?php if ($product['product_brand'] == 'No brand') echo ' selected'; ?>>No brand</option>
                                            <option value="Rolex" <?php if ($product['product_brand'] == 'Rolex') echo ' selected'; ?>>Rolex</option>
                                            <option value="Hermes" <?php if ($product['product_brand'] == 'Hermes') echo ' selected'; ?>>Hermes</option>
                                            <option value="Channel" <?php if ($product['product_brand'] == 'Channel') echo ' selected'; ?>>Channel</option>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <select class="form-control" name="product_category">
                                            ...
                                            <option value="vip" <?php if ($product['product_category'] == 'vip') echo ' selected'; ?>>vip</option>
                                            <option value="anime" <?php if ($product['product_category'] == 'anime') echo ' selected'; ?>>anime</option>
                                            <option value="normal" <?php if ($product['product_category'] == 'normal') echo ' selected'; ?>>normal</option>
                                        </select>
                                    </div>
                                    <div class="form-group">
