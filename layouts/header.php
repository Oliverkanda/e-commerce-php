...
<head>
    ...
    <link rel="icon" href="assets/img/icon/key-icon.svg" type="image/svg">
</head>
...
<body>
    ...
    <div class="offcanvas-menu-wrapper">
        ...
        <div class="offcanvas__text">
            <p>Free shipping, mua móc khóa ngay.</p>
        </div>
    </div>
    <!-- Offcanvas Menu End -->
            ...
            <div class="row">
                <div class="col-lg-3 col-md-3">
                    <div class="header__logo">
                        <a href="../index.php"><img src="assets/img/mlogo.png" alt=""></a>
                    </div>
                </div>
                <div class="col-lg-6 col-md-6">
                    <nav class="header__menu mobile-menu">
                        <ul>
                            <li <?php if($_SERVER['SCRIPT_NAME']=="/index.php") { ?>  class="active"   <?php   }  ?>><a href="../index.php">Trang chủ</a></li>
                            <li <?php if($_SERVER['SCRIPT_NAME']=="/shop.php") { ?>  class="active"   <?php   }  ?>><a href="../shop.php">Shop</a></li>
                            <li <?php if($_SERVER['SCRIPT_NAME']=="/about.php") { ?>  class="active"   <?php   }  ?>><a href="../about.php">Về chúng tôi</a></li>
                            <li <?php if($_SERVER['SCRIPT_NAME']=="/contact.php") { ?>  class="active"   <?php   }  ?>><a href="../contact.php">Liên hệ</a></li>
                        </ul>
                    </nav>
                </div>
                <div class="col-lg-3 col-md-3">
