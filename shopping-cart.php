        ...
        <div class="row">
                                    ...
                                    <tr>
                                        <td class="product__cart__item">
                                            ...
                                            <div class="product__cart__item__text">
                                                ...
                                                <h5><?php echo setPrice(($value['product_price'] * $convert_dollar)); ?></h5>
                                            </div>
                                        </td>
                                        ...
                                        <td class="cart__price">
                                            <span><?php echo setPrice(($value['product_quantity'] * ($value['product_price'] * $convert_dollar))); ?> </span>
                                        </td>
                                        <form method="POST" action="shopping-cart.php">
                                            <td>
                                                <input type="hidden" name="product_id" value="<?php echo $value['product_id'] ?>">
            ...
            <div class="col-lg-4">
                ...
                <div class="cart__total">
                    <h6>Cart total</h6>
                    <ul>
                        <li>Total <span><?php if(isset($_SESSION['cart'])) { echo setPrice($_SESSION['total'] * $convert_dollar); } ?></span></li>
                    </ul>
